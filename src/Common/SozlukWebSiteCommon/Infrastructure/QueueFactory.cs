...
namespace SozlukWebSiteCommon.Infrastructure
{
    public static class QueueFactory
    {
        //SendMessageToExchange metodu çağırıldığında gidecek bir tane Consumer oluşturacak daha sonra yoksa exchange yaratacak 
        //varsa var olanı kullancak sonra queuelara bakacak yoksa queue yaratacak ve daha sonra consumer'ın kanalını getirecek
        //bizde bu kanalı kullanarak  obje gönderecem.
