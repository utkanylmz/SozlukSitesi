...
namespace SozlukWebSitesi.WebApp.Infrastructure.Services
{
    public class EntryService : IEntryService
    {
        ...
        public async Task<PagedViewModel<GetEntriesCommentsViewModel>> GetEntryComments(Guid entryId, int page, int pageSize)
        {
            var result = await client.GetFromJsonAsync<PagedViewModel<GetEntriesCommentsViewModel>>($"/api/entry/comments/{entryId}?page={page}&pageSize={pageSize}");
